...
# Name: TotalSpaces2-Version
# Description: Check the version number of an application, & set it to NOT update or prompt to update.
# Data Type: Integer
...
pref=com.binaryage.TotalSpaces2.plist
