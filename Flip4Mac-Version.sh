...
app="/Library/PreferencePanes/Flip4Mac WMV.prefPane"
# example: 
# "iTunes.app" 
...
pref=net.telestream.wmv.plist
# For the do not update command
# Examples: 
# com.apple.iTunes.plist
# com.sketchup.SketchUp.2015.plist

updatesKey=UpdateCheck_CheckInterval
...
versionNumKey=CFBundleShortVersionString
...
Version="$(defaults read "$app"/Contents/Info.plist $versionNumKey)"
